(function() {
	...
	BX.Landing.Utils.Matchers = {
		...
		instagram: new RegExp("(instagr/index.html\\.am|instagram\\.com)\\/p\\/([a-zA-Z0-9_\\-]+)\\/?"),
		...
		facebookPosts: new RegExp("%5ehttps_/index.html\/\/www\.facebook\.com\/(photo(\.php|s)|permalink\.php|media|questions|notes|[^\/]+\/(activity|posts))[\/?].*$"),
